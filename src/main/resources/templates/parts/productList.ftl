        ...
        <#if product.productStatus.title != 'Deleted'>
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card my-2">
                    ...
                    <div class="ml-2">
                        <label for="rating"><#if product.rating??>${product.rating}</#if></label>
                        <i class="fas fa-star" style="color: orange"></i>
                    </div>

                    <a href="/products/${product.id}" style="text-align: center" class="p-2">
                        <#if product.photo??>
                    ...
                    <div>
                        <div class="m-2">
                            <span style="font-size: 15px">${product.title}</span><br>
                            ...
                            <a href="#"><strong style="font-size: 20px">${product.price - product.discount} hrn</strong></a>
                        </div>
                        ...
                        <div class="card-footer text-muted">
                            ...
                            <#else >
                                ...
                                <#else >
                                    <a href="/products/add_to_cart/${product.id}" class="btn btn-primary">Add to
                                        cart</a>
                                </#if>
                            </#if>
                        </div>
